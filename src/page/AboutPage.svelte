...
<div class="container">
    ...
    <p class="lead text-muted pt-3">
        Find out more at:<br>
        <a href="https://linkedin.com/in/ftglass" class="btn btn-outline-primary my-2">LinkedIn</a>
        <a href="https://github.com/fglass" class="btn btn-outline-secondary my-2">GitHub</a>
    </p>
</div>
